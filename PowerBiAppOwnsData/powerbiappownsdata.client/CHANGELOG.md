...
- Create Angular project with ng: `ng new powerbiappownsdata.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`powerbiappownsdata.client.esproj`).
