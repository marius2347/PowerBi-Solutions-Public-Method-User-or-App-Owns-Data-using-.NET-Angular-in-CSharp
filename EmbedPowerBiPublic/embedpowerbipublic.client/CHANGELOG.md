...
- Create Angular project with ng: `ng new embedpowerbipublic.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`embedpowerbipublic.client.esproj`).
