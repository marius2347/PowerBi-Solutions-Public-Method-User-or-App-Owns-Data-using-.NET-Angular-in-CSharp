...
- Create Angular project with ng: `ng new powerbiuserownsdata.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`powerbiuserownsdata.client.esproj`).
